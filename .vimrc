"shamelessly stolen from jhunt/env
"top stuff is my old stuff for posterity
...
if has("autocmd")
  ...
  " Treat *.rsc as MikoTik configurations
  au BufRead,BufNewFile *.rsc                   set ft=rsc et ts=2 sts=2 sw=2
